...
your_city = st.selectbox("🌎 Select a city", cities)
...
plt.legend(
    loc="center", bbox_to_anchor=(0.5, -0.1), ncol=2, framealpha=0, labelcolor="#00FF7F"
)
plt.tight_layout()
